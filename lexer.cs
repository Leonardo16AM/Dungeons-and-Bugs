...
class lexer{
    List<string>token_names=new List<string>(){"GET","LET","DIF","EQ","PLUS","MINUS","MUL","DIV","ASG","LPAREN","RPAREN","LKEY",
    "RKEY","SCOL","AND","OR","GT","LT","NOTI","IF","ELSE","WHILE","NOTIP","COMA","SLEEP","ADDP","DELP","ENDT","RET","DEF","RCOR","LCOR","FOR"};
    List<string>token_string=new List<string>(){">=","<=","!=","==","+","-","*","/","=","(",")","{","}",";","&","|",">","<","notify",
        "if","else","while","notipic",",","sleep","add_power","del_power","end_turn","return","def","[","]","for"};
